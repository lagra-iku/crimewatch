...
class AddNewOfficer(AbstractBaseUser, PermissionsMixin):
    ...
    groups = models.ManyToManyField('auth.Group', related_name='add_new_officer_groups')
    user_permissions = models.ManyToManyField('auth.Permission', related_name='add_new_officer_permissions')
